        ...
        saveNoteBtn.addEventListener("click", function () {
            fetch("http://127.0.0.1:8000/all-tickets/add-note", {
                ...
                .then(data => {
                    ...
                    document.getElementById("details-note").innerText = adminNote.value;
...
document.getElementById("print-ticket-btn").addEventListener("click", function () {
    if (payloadObj.role === "admin") {
        document.getElementById("details-state").innerText = changedState.value;
    }
    document.getElementById("details-state").style.display = "inline";
    window.print();
});